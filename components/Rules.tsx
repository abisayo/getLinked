...
const RulesPage = () => {
    return (
        ...
        flex-col-reverse justify-evenly gap-x-0'>
            ...
            <motion.div variants={slideIn("left", "type", 0.2, 1)} className='xl:pt-48 md:py-20 mb-[70px] px-10'>
            ...
            {/* Right */}
            <motion.div variants={slideIn("right", "type", 0.2, 1)} className='xl:py-0 md:py-16' >
