        ...
        <section className='w-full flex-col justify-evenly py-[0px] bg-backgroundImage-site bg-cover'>
          ...
          md:p-32 sm:p-16 px-6 2xl:scale-100 xl:scale-75 scale-[100%] mb-36'>
                <div className='grid grid-cols-5 auto-cols-auto justify-items-center'>
                    <motion.div whileHover={{ scale: 1.1 }} className='md:border-b-2 border-b-2 md:p-5 sm:p-3 pt-3 lg:w-[260px] boder-bottom'>
                    ...
                    <motion.div whileHover={{ scale: 1.1 }} className='md:pt-16 pt-10 md:border-b-2 border-b-2 lg:w-[260px] boder-bottom'>
                    ...
                    <motion.div whileHover={{ scale: 1.1 }} className='sm:pt-0 pt-4 md:border-b-2 border-b-2 lg:w-[260px] boder-bottom '>
                        <Image src='/winwise.png' width={132} height={108} alt='Winwise' className='mx-auto sm:scale-100 scale-75' />
                    </motion.div>
                    <motion.div whileHover={{ scale: 1.1 }} className='md:pt-6 pt-3 lg:w-[260px] md:scale-100 scale-75'>
                        <Image src='/whispersms.png' width={148} height={110} alt='Whimsperms' className='mx-auto' />
                    </motion.div>
                    <div className='lg:mt-[30px] sm:scale-[80%] scale-50'>
                        <Image src='/line-p.png' width={4} height={100} alt='Line' />
                    </div>
                    <motion.div whileHover={{ scale: 1.1 }} className='md:pt-12 pt-8 lg:w-[260px] md:scale-100 scale-75'>
                        <Image src='/paybox.png' width={205} height={21} alt='paybox' className='mx-auto' />
                    </motion.div>
                    <div className='lg:mt-[30px] sm:scale-[80%] scale-50'>
                        <Image src='/line-p.png' width={4} height={100} alt='Line' />
                    </div>
                    <motion.div whileHover={{ scale: 1.1 }} className='md:pt-12 pt-8 lg:w-[260px] md:scale-100 scale-90'>
            ...
            <div
                className='absolute mix-blend-hard-light
                 bg-no-repeat opacity-80 blur -z-50 -right-0 mt-[-300px]'>
                <Image
                    src='/purple-lens.png'
                    alt='purple-lens'
                    width={1037}
